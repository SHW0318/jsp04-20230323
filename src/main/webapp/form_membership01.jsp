...
<body>
	...
	<form action="form_membership02.jsp" name="person_info" method="get">
		<fieldset style="width:330px">
			...
			<input type="tel" maxlength="3" size="3" name="phone1"> -
			<input type="tel" maxlength="4" size="4" name="phone2"> -
			<input type="tel" maxlenght="4" size="4" name="phone3"><br><br>
			성별 : 
			<input type="radio" value="남성" name="gender">남
			<input type="radio" value="여성" name="gender">여 <br><br>
			취미 : 
